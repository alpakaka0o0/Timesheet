...
os.environ['GOOGLE_APPLICATION_CREDENTIALS'] = 'summer-branch-410822-fc2d8cfced84.json'
...
def extract_text(path):
    ...
    return(employee_name, manager_name, weekStart, header, data, employeeSign, managerSign)

# employee_name, manager_name, weekStart, header, data, employeeSign, managerSign = extract_text(path)
# print()
# print("====================================")
# print(employee_name, manager_name, weekStart, header, data, employeeSign, managerSign)